...
// V1에는 ScoreSerivce 인터페이스가 impl 되어있기 때문에
// V1을 상속받으면 자동으로 인터페이스도 상속받게 된다
public class ScoreSeriveImplV2 extends ScoreServiceImplV1 {

	/*
	 * scoreList에 성적정보를 추가할때 학번을 입력받을텐데 이미 등록된 학번 정보가 있으면 그 학번은 추가 하지 못하도록 하는 코드
	 * 
	 * V1의 inputNum() method를 재 정의 한다 V1의 inputNum() method를 재 정의하기 위하여 private를
	 * protected로 변경했다
	 */
	@Override
