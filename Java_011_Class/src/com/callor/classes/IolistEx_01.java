...
public class IolistEx_01 {
	 ...
	 * 
	 * 3. 실행 :  컴파일되어서 생성된 IolistEx_01.class 파일을 컴퓨터메모리에 load하고 프로젝트를 실행
	 * 			java IolistEx_01
	 * 
	 ...
	 * 					가상머신이 java로 컴파일된 코드 파일에서 제일먼저 찾는 method
	 * 					java IolistEx_01이라고 실행을 지시하면 IolistEx_01.main("dlfdhnafjklda")를 호출하여 코드를 실행하기 시작한다 
	 */
	public static void main(String[] args) {
		 ...
		 * 3. 지금 만든 IolistVO클래스의 맴버변수는 모두 private 이기 때문에 객체.맴버변수 형식으로는 값을 저장할수 없다
		 * 4. 맴버변수에 값을 저장할때 setter method를 통해서 저장을 해야 한다
		 */
