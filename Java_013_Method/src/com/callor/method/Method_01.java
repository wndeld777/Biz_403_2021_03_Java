...
public class Method_01 {
	...
	public static void main(String[] args) {
		 ...
		 * Random() 생성자 method를 호출하여 객체를 생성(초기화)하는 코드
		 ...
		 * Scanner() 생성자는 객체를 생성할때 System.in(키보드 입력 장치)를 연결할수 있도록 매개변수에 정보를 전달해 주어야 한다.
		 */
		...
		if(int1 % 2 == 0) {
			...
			System.out.println(int1 + "은 짝수가 아니다"); // 더 정확한 표현
		}
