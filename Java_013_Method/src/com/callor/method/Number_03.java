...
public class Number_03 {
	...
	public static void main(String[] args) {
		...
		if(strInput.trim().equals("QUIT")) {
			 ...
			 * 	NumberFormatException 이 발생하면
			 * 	코드가 중단되는데
			 * 	코드를 중단하지 않고, 사용자에게 메시지등을 전달하고
			 * 	적절한 연산코드를 추가하여
			 * 	코드를 계속 진행하도록 하는 조치
			 * 
			 * 예외처리 코드는 개발자에게는 상당히 불필요한 코드를 추가하여 부담을 주는 것일수 있다
			 * 	하지만, 적절한 예외처리를 해준 코드는 End User(실제 사용자)에게 불편함을 최소한으로 주는 적절한 방법
			 * 
