 ...
 * 모두 파일로 제공하고 필요에 따라 import하여 사용할수 있도록 하고있다.
 * 
 * import java.util.Random;
...
public class Controller_06 {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * 키워드: java가 처음 탄생될때부터 만들어진 명령어
		 * class : 키워드처럼 사용이 되지만 java가 탄생하고
		 * 			이후에 필요에 따라 추가, 확장된 명령
		 */
		Random rnd = null; // 선언
		rnd = new Random(); // 초기화
		 ...
		 * 확장된 기능을 할수 있도록 만들어진 class이다
		 * 
		 * 기본 기능은 값을 저장하는 변수를 선언한다
		 * 기본기능에 별도로 확장된 추가명령을 수행할수 있도록 만들어진 도구들이다
		 */
