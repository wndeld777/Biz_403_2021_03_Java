...
public class InputServiceV2 {
	...
	public Integer inputValue(String title, int start, int end) {
		...
		String msgTitle = String.format("%s(%d ~ %d 범위의 값)",title, start, end);
		...
		while(true) {
			...
			// 유효한 범위의 정수를 return 했으면 그 값이 담겨 있다
			// 그 값을 return 하라
			return intNum;	
		}
	...
	public Integer inputValue(String title) {
		/*
		 * exception 이 발생했을때 사용자에게 안내메시지를 보여주고
