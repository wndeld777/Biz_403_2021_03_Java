package com.wndeld777.stnadard.impl;
...
/*
 * 인터페이스를 implements 한 클래스는 이름을 지을때 접미사에 보통 Impl을 붙인다
 * 
 * 인터페이스를 impl 한 클래스는 인터페이스에 설계된 추상메서드를 "반드시" 구체적인 코드로 구현해야 한다.
 * 
 * 만약 아직 구체적인 코드가 구현되지 않았더라도 method의 형태는 삭제할수 없다
 * 
