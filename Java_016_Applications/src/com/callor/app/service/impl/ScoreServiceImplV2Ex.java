...
public class ScoreServiceImplV2Ex extends ScoreServiceImplV2 {
	...
	// 과목명, 과목점수가 담긴 배열에 대한 위치를 숫자로 사용하지않고 명명된 이름으로 사용하기 위하여
	...
	public void inputScore() {
		...
		if (intNum == null) {
			return; // void 일때 return뒤에 아무것도 쓰지않는다
		}
		// 1을 입력했으면 2021001로 만들어라
		...
		// 점수를 입력하는 곳에서 사용하기 위하여 과목명을 담을 배열을 선언했는데 생각해보니
		// 다른 method에서도 사용할수 있을것 같아서 클래스 영역으로 이동하였다

		// 과목 수 만큼 점수를 저장할 배열을 선언
