...
public class ScoreVO {
	 ...
	 * 
	 * 그런데 total, avg변수도 public으로 선언을 해 두었더니
	 ...
	 * 
	 * VO 클래스의 맴버변수를 private으로 선언하면 다른곳에서 객체를 통해(점연결 연산자를 통해) 직접 접근이 불가능 해 진다.
	 * 
	 * total, avg를 private으로 선언하면 누구도 직접 total, avg에 값을 저장 할 수 없다.
	 * 
